"""Runtime wiring for the structured ``octop-memory`` integration.
...
from octop_harness.memory.store import (
    MemoryIdentity,
...
class MemoryRuntime:
    ...
    namespace + DSN/path (see ``octop_harness.memory.store``). Rebuilds swap
