...
class MCPProtocol(LangGraphProtocol):
    ...
    def _parse_mcp_request(
        ...
        for msg in request.get("messages", []):
            ...
            # Handle content as object, content-block array, or plain string.
            # str() on a list or None would leak a Python repr / "None" into the
            # model prompt, so extract text blocks explicitly.
